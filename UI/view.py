...
class View(ft.UserControl):
    ...
    def load_interface(self):
        # title
        self._title = ft.Text("TdP 2024 - Esame del 16-09-2024 - B", color="blue", size=24)
        ...
        self.txxt_result1 = ft.ListView(width=400, expand=1, spacing=10, padding=20, auto_scroll=False)
